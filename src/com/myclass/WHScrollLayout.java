 ...
 *
 */
public class WHScrollLayout extends ViewGroup {
	private static String TAG = "WHScrollLayout";
    ...
    public WHScrollLayout(Context context) {
        super(context);
        init(context);
    }

    public WHScrollLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
